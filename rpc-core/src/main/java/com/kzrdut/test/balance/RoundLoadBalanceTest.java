package com.kzrdut.test.balance;

import com.kzrdut.client.servicecenter.balance.impl.RoundLoadBalance;
...
public class RoundLoadBalanceTest {
    ...
    public void testBalance_RoundRobin() {
        ...
        String fourthSelection = loadBalance.balance(addressList);
        ...
        assertEquals(firstSelection, fourthSelection);
    }
}
